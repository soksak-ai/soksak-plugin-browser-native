...
import { createBrowserToolbar } from "soksak-kit-browser-chassis";
import type { BrowserToolbar } from "soksak-kit-browser-chassis";
...
function BrowserViewImpl({
  ...
  // 공용 툴바(soksak-kit-browser-chassis) — 세 브라우저 동일 DOM·노드·외형. 콜백은 ref 경유(재마운트 없음).
  ...
  return (
    <div className="browser-view">
      {/* 공용 툴바(soksak-kit-browser-chassis) 호스트 — 고유 버튼(devtools·북마크 메뉴)은 extraSlot 포털. */}
