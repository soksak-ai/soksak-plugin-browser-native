...
function BrowserViewImpl({
  ...
  const toggleBookmark = (0, import_react.useCallback)(async () => {
    if (!app.data) return;
    ...
    bmOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "bv-bm-list", children: [
      ...
      bookmarks.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bv-bm-title", children: b.title }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "bv-bm-url", children: b.url })
          ]
        },
        b.url
      ))
